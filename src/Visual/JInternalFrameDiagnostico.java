...
public class JInternalFrameDiagnostico extends javax.swing.JInternalFrame {
    ...
    private void llenarTabla() {
        ...
        listado.setColumnIdentifiers(columnas);
        //ciclo para recorrer la lista de productos
        for (Listado pro : Lista) {
            ...
            jTableDiagnostico.setModel(listado);
        }
    }
    ...
    private void initComponents() {
        ...
        jComboBoxMecanico.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        jPanel1.add(jButtonGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 400, -1, -1));
        ...
        if ((jTextFieldDiagnostico.getText().equals(""))
            ...
            try {//Bloqueo llamado try (intentar) - catch (capturar) para capturar errores
                ...
                //llama al metodo constructor de clase producto
                 Listado prod = new Listado(DiagnosticoV, ModeloV, PlacaV, TipoV, MecanicoV);
